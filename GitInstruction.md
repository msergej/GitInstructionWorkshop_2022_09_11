...
Для работы с ветками используется команда git branch с различными параметрами.

### Что такое ветки и для чего они нужны при работе с системой контроля версий.
Ветки позволяю команде из нескольких человек работать над одним документом.
